...
// linha 10
    public TelaListagem(JFrame telaAnterior) {
        ...
        // linha 11
        setTitle("Lista de Entregadores");
        ...
        // linha 19
        for (entregador e : SistemaPizzariaGUI.getEntregadores()) {
            ...
            // linha 21
            sb.append("Placa da Moto: ").append(e.getPlacaMoto()).append("\n");
            // Adiciona a placa do veículo.

            // linha 22
            sb.append("Telefone: ").append(e.getTelefone()).append(")\n");
            // Adiciona o nome e telefone do dono.
            // Note que usamos "v.getDono()" para acessar o cliente associado ao veículo.
        ...
        // linha 24
        if (sb.length() == 0)
            sb.append("Nenhum entregador cadastrado.");
