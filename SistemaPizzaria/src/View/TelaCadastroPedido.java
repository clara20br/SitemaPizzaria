...
// linha 9
    ...
    // linha 10
    private JTextField txtnumTamanho, txtnumPedido;
    ...
    // linha 12
    public TelaCadastroPedido(JFrame telaAnterior) {
        ...
        // linha 17
        setLayout(new GridLayout(18, 5, 30, 5));
        ...
        add(new JLabel("-------------Sabores de Pizza-----------------"));
        add(new JLabel("Calabresa"));
        add(new JLabel("Frango com catupiri"));
        add(new JLabel("Quatro Queijos"));
        add(new JLabel("Mussarela"));
        add(new JLabel("Portuguesa"));
        
        add(new JLabel("-------------Tamanhos de Pizza-----------------"));
        add(new JLabel("Digite o numero correspondente ao tamanho da Pizza"));
        add(new JLabel("1 - Pequena (4 fatias)"));
        add(new JLabel("2 - Media (8 fatias)"));
        add(new JLabel("3 - Grande (12 fatias)"));
     
        
        
        add(new JLabel("Sabor da pizza:"));
        ...
        btnSalvar.addActionListener(e -> {
            ...
            Double.parseDouble(txtnumTamanho.getText()),
            	txtnumPedido.getText()
            ...
            // linha 41
            SistemaPizzariaGUI.adicionarPedido(pedido);
            ...
            // linha 42
            JOptionPane.showMessageDialog(this, "✅ Pedidp cadastrado com sucesso!");
            // Exibe uma janela de mensagem informando que o cadastro foi realizado.

            // linha 43–47
            txtnumTamanho.setText("");
